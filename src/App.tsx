      ...
      <main id="main-content">
        <section className="hero section" id="top" aria-labelledby="portfolio-title">
          <div className="hero__copy">
            <div className="availability"><span aria-hidden="true" /> DISPONIBLE · STAGE 4 MOIS · À PARTIR DE FÉVRIER 2027</div>
        ...
        <section className="section split-section" id="profil">
          <div><SectionLabel index="01" title="PROFIL" /><h2>Je construis des infrastructures <em>structurées, sécurisées et maintenables.</em></h2><p className="lead">Mon parcours en Réseaux & Télécommunications m'amène à considérer une infrastructure dans son ensemble : réseau, systèmes, sécurité, services et automatisation.</p></div>
          <aside className="info-panel"><p className="panel-label">INFORMATIONS DU PROFIL</p><dl><div><dt>FORMATION</dt><dd>BUT R&T · 3E ANNÉE</dd></div><div><dt>PARCOURS</dt><dd>CYBERSÉCURITÉ</dd></div><div><dt>LOCALISATION</dt><dd>ÎLE-DE-FRANCE</dd></div><div><dt>OBJECTIF</dt><dd>STAGE 4 MOIS · FÉVRIER 2027</dd></div></dl></aside>
        </section>
