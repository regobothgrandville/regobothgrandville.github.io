  ...
  return (
    <div className="app-shell">
      ...
      <header className="site-header">
        ...
        <a className="button button--small button--ghost" href={cvHref} target="_blank" rel="noreferrer" aria-label="Ouvrir mon CV de stage au format PDF dans un nouvel onglet">CV ↗</a>
      </header>
      ...
      <main id="main-content">
        <section className="hero section" id="top" aria-labelledby="portfolio-title">
          <div className="hero__copy">
            ...
            <div className="hero__actions"><a className="button button--primary" href="#projets">Explorer mes projets</a><a className="button button--ghost" href="https://github.com/regobothgrandville" target="_blank" rel="noreferrer" aria-label="Voir mon profil GitHub dans un nouvel onglet">GitHub ↗</a></div>
          ...
          <a className="scroll-cue" href="#profil">DÉFILER <span aria-hidden="true">↓</span></a>
        </section>
