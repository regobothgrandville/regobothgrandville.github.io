  ...
  return (
    <main className="case-study">
      <header className="case-header">
        <a className="brand" href="/">RG<span>.</span></a>
      ...
      <section className="case-footer-panel">
        ...
        {project.github && <a className="button button--ghost" href={project.github} target="_blank" rel="noreferrer">VOIR LE DÉPÔT GITHUB ↗</a>}
      </section>

      <footer className="case-site-footer"><a className="brand" href="/">RG<span>.</span></a><span>NETWORK OBSERVATORY // {project.index}</span></footer>
    </main>
  )
}
